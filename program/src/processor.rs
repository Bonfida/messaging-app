...
use crate::instruction::JabInstruction;
...
impl Processor {
    pub fn process_instruction(
        ...
        let instruction = JabInstruction::try_from_slice(&instruction_data[0..1])
            .map_err(|_| ProgramError::InvalidInstructionData)?;
        msg!("Instruction unpacked");

        match instruction {
            JabInstruction::CreateProfile => {
            ...
            JabInstruction::CreateGroupThread => {
            ...
            JabInstruction::EditGroupThread => {
            ...
            JabInstruction::SendMessageGroup => {
            ...
            JabInstruction::AddAdminToGroup => {
            ...
            JabInstruction::RemoveAdminFromGroup => {
            ...
            JabInstruction::CreateGroupIndex => {
            ...
            JabInstruction::DeleteGroupMessage => {
            ...
            JabInstruction::CreateSubscription => {
